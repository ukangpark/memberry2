...
public class CommentService {
	...
	public Map<String, Object> add(Comment comment, Authentication authentication) {
		...
		if(cnt == 1) {
			res.put("messgae", "댓글이 등록되었습니다.");
		} else {
			res.put("messgae", "댓글이 등록되지 않았습니다.");
		}
		return res;
	}
	...
	public Map<String, Object> remove(Integer id) {
		...
		if(cnt == 1) {
			res.put("messgae", "댓글이 삭제되었습니다.");
		} else {
			res.put("messgae", "댓글이 삭제되지 않았습니다.");
		}
		return res;
	...
	public Map<String, Object> update(Comment comment) {
		...
		var res = new HashMap<String, Object>();
		if(cnt == 1) {
			res.put("messgae", "댓글이 수정되었습니다.");
		} else {
			res.put("messgae", "댓글이 수정되지 않았습니다.");
		}
		return res;
