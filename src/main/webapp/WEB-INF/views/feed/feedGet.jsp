		...
		<div class="d-flex">
			...
			<div class="ui card" id="my-card">
				...
				<div class="content">
					...
					<span class="likeIcon" data-feed-id="${feed.id }"> <c:if
							test="${feed.liked }">
							<img src="/images/bone.png">
						</c:if> <c:if test="${not feed.liked }">
							<img src="/images/olbone.png">
						</c:if>
					</span> <span class="likeNumber"
						style="font-weight: 300; font-size: large;">
						${feed.likeCount } </span> <span
						style="font-weight: 300; font-size: large;">likes</span> <span
						class="left floated"
						style="margin-right: 200px; font-weight: 300; font-size: large;">
						<button type="button"
							class="btn btn-secondary-link btnTriggerModal position-relative"
							id="commentIcon" data-bs-toggle="modal"
							data-bs-target="#commentModal" data-id="${feed.id }">
				...
				<div class="extra content">
					<div class="ui large transparent right icon input">
						<input size=42 type="text" placeholder="Add Comment..."><img
